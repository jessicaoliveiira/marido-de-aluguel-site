          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                ...
                >
                  <Phone className="w-4 h-4 mt-0.5 flex-shrink-0 text-brand-blue-light" aria-hidden="true" />
                  {siteConfig.phoneFormatted}
                </a>
              </li>

              <li className="flex items-start gap-2 text-sm text-gray-400">
                <MapPin className="w-4 h-4 mt-0.5 flex-shrink-0 text-brand-blue-light" aria-hidden="true" />
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="mt-5 btn-whatsapp text-sm py-2.5 w-full justify-center"
